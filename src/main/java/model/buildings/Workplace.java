...
public abstract class Workplace extends GeneratedBuilding {
     ...
     */
    public Workplace(Image texture, Coordinate coords, double firePossibility, boolean isOnFire, ArrayList<Person> people, SaturationRate saturationRate, int publicSafety) {
